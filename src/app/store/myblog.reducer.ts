...
const initialState: MyblogState = {
  ...
  descriptionsData:[
    ...
    {
      text:"Вверхней част распологается удобный поиск по тегам , поиск реализован при помощи app/pipes/search-tag  каждый блог имеет стой URL с id",
      img:8,
    },
    {
      text:"Вверхней част распологается удобный поиск по тегам , поиск реализован при помощи app/pipes/search-tag  ",
      img:8,
    },
    {
    ...
    {
      text:"просмотреть коментарии можно нажав на имя пользователя ",
      img:17,
    },
    {
    ...
    {
      text:"Во вкладке  'Статистика' можно постомтерь различные статистические данные графичести продемонстрированные в виде грфиков, графики строются при помощи библиотеки echarts ",
      img:20,
    },
