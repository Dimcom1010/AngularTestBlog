  ...
  blogList : [
    {
      id: 1,
      name: "Dima",
      topic: "Элементы политического процесса",
    ...
    },
    {
      id: 2,
      name: "Dima",
      topic: "Принимая во внимание показатели успешности",
    ...
    },
    {
      id: 3,
      name: "Admin",
      topic: "В целом, конечно, постоянное",
    ...
    },
    {
      id: 6,
      name: "Dima",
      topic: "Высокий уровень вовлечения представителей",
    ...
    },
    {
      id: 7,
      name: "Admin",
      topic: "А ещё предприниматели в сети интернет",
    ...
    },
    {
      id: 8,
      name: "Admin",
      topic: "Значимость этих проблем настолько очевидна",
...
debugger
    ...
    //       ...state,
    // blogList: state.blogList.map(blog => blog.id === Action.payload.id ?{
    //     like_position: [...blog.like_position,50]
    //   }

    //   :blog)
    case  myblogActionType.clickDisLike: // 12 создаём новый case onDisabledLikeActions 13-в widget.ts написать диспатч
      ...
      return {
        ...
        blogList: state.blogList.map(blog => blog.id == Action.payload.id ? {
          ...blog,
          // like_position: []
          like_position: blog.like_position.filter(x=>x==Action.payload.id)
